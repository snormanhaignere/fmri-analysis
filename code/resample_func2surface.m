...
if ~exist(surf_file,'file') || optInputs(varargin,'overwrite')
  unix_freesurfer_version(freesurfer_version, ['mri_vol2surf --ref ' refvol ' --mov ' volfile ...
      ' --reg ' regfile ' --o ' surf_file ' --hemi ' hemi ' --surf white --interp ' interpmethod ...
      ' --projfrac-avg ' num2str(projfrac(1)) ' ' num2str(projfrac(2)) ' 0.05']);
end
...
if ~exist(fsaverage_file,'file') || optInputs(varargin,'overwrite')
  unix_freesurfer_version(freesurfer_version, ['mri_surf2surf --srcsubject ' subjid ' --sval ' surf_file ...
      ' --trgsubject fsaverage --tval ' fsaverage_file  ' --hemi ' hemi]);
end