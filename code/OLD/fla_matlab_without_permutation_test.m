...
if ~exist(beta_file,'file') || ~exist(psc_file,'file') || ~exist(rvar_file,'file') || exist(beta_white_file,'file') || ~exist(psc_white_file,'file') || ~exist(rvar_white_file,'file')  || optInputs(varargin, 'overwrite')
    ...
    save(design_file,'X_design','X_nuissance','X','acf_residual','acf_whitened_residual','acf_residual_inverse','df');
end
