...
%     scatter(vras_boundary_pts(:,1),vras_boundary_pts(:,2),3,double(mask));
    ...
    grid_mask = griddata(vras_boundary_pts(:,1),vras_boundary_pts(:,2),double(mask),G.grid_x{i},G.grid_y{i},'v4');
        
%     scatter(G.grid_x{i}(:),G.grid_y{i}(:),3,grid_mask(:));
