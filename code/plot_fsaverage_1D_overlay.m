...
nvertices = 163842; 
[vertices, faces] = freesurfer_read_surf([params('rootdir') 'freesurfer/fsaverage/surf/' hemi '.inflated']);

% set default color data based on gyral/sulcal divisions
curv = read_curv([params('rootdir') 'freesurfer/fsaverage/surf/' hemi '.curv']);
